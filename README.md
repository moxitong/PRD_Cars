...
此款API与车型识别API一样，只针对常见小汽车车型，大型汽车比如巴士、拖拉机等的车型可能无法识别出准确信息；另外，此款API所需要的识别时长较长，经过测试大概时间为2-4秒，当用户使用时可能会产生不耐烦等情绪。
...
|   性价比（以驾驶证识别为例） |  25元/千次-40元/千次  |  30元/千次-120/千次  |  70.28元/千次  |
