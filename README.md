...
# Catalogue（目录）
[PRD价值主张设计](#PRD 价值主张设计 15%)
- [PRD1.加值宣言](#PRD1.加值宣言 3%)
- [PRD2.核心价值](#PRD2.核心价值（MVP） 3%)
- [PRD3.核心价值与用户痛点](#PRD3.核心价值与用户痛点 3%)
- [PRD4.人工智能概率性与用户痛点](#PRD4.人工智能概率性与用户痛点 3%)
- [PRD5.需求列表与人工智能API加值](#PRD5.需求列表与人工智能API加值 3%)
